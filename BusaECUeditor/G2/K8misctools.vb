...
Public Class K8misctools
    Dim ADJ As Integer = &H59E00 '&HFF if shifter inactive, no code present else shifter active
    Dim TOOLSCODE As Integer = &H59E00
    Dim IDTAG As Integer = &H55DC0
    ...
    Private Sub modify_original_ECU_code(ByVal method As Boolean)
        ...
        If method Then
            ...
            WriteFlashWord(&H22A4, &HFE00) ' bl.l 
            WriteFlashWord(&H22A6, pcdisp) '         pcdisp
        Else
            '

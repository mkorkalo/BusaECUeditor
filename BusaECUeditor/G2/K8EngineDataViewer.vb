...
Public Class K8EngineDataViewer
    ...
    Private Sub K8EngineDataViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ElseIf My.Settings.AutoTuneBoostPressureSensor = 1 Then
            ...
            _boostList.Add(28)
            _boostList.Add(31)
        ElseIf My.Settings.AutoTuneBoostPressureSensor = 2 Then
            _boostList.Add(0)
            _boostList.Add(1)
            _boostList.Add(3)
            _boostList.Add(5)
        ...
        If My.Settings.AutoTuneBoostPressureSensor < 2 Then
        ...
        Else
            ...
            _boostRPMList.Add(12500)
            _boostRPMList.Add(13000)
            _boostRPMList.Add(13500)
            _boostRPMList.Add(14000)
            _boostRPMList.Add(14500)
            _boostRPMList.Add(15000)
            _boostRPMList.Add(15500)
            _boostRPMList.Add(16000)
        End If
    ...
    Public Sub OpenLogFile()
        Try
            If String.IsNullOrEmpty(_filePath) = False Then
                ...
                Dim reader As BinaryReader = New BinaryReader(File.OpenRead(_filePath))
                Dim logValues As List(Of LogValue) = New List(Of LogValue)
                Dim previousLogValue As New LogValue
    ...
    Public Function CheckEngineDataFilter(ByRef logValue As LogValue, ByRef previousLogValue As LogValue)
        ...
        If My.Settings.FilterZeroRPMData = True Then
            If logValue.RPM < 500 Then
                Return False
            End If
        End If

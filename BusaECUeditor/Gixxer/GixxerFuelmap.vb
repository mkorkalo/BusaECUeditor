...
Public Class GixxerFuelmap
    ...
    Private Sub setCellColour(ByVal c As Integer, ByVal r As Integer)
        ...
        If (Me.Visible) Then
            ...
            If Me.Text.Contains("TPS") And c < 9 Then Fuelmapgrid.Item(c, r).Style.ForeColor = Color.Gray
    ...
    Private Sub SetFlashItem(ByVal c As Integer, ByVal r As Integer)
        ...
        Dim copy_to_map, copy_to_map2 As Long
    ...
    Private Sub B_Apply_Map_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles B_Apply_MAP.Click
        ...
        fdlg.Filter = "PCV (*.pvm)|*.pvm|BZ (*.zfm1)|*.zfm1|bin (*.bin)|*.bin"
        fdlg.FilterIndex = 1
                ...
                Case "bin"
                    ...
                    For rp = 0 To nor - 1
                        For cp = 0 To noc - 1
                            ...
                            If Fuelmapgrid.Item(cp, rp).Value >= maxval Then Fuelmapgrid.Item(cp, rp).Value = maxval
